...
function clik (btn){
  btn.textContent == "dimaafin 🤗" ? img.src = "img/malu.gif" : img.src = "img/patahHati.gif" 
  button[0].style.display = "none"
  button[1].style.display = "none"
  ctn.style.height = "250px"
  ctn.style.width = "270px"
  return btn.textContent == "dimaafin 🤗" ? kata.textContent = "😍 ni buat si comel 🍊" : kata.textContent = "😭😭😭😭😭😭"
...
function content(){
  ...
  kata.textContent = "Hay, cuma mau ucapin, semangat ya, maap klo kerjaan nya cuma bikin marah 🥲"
}
